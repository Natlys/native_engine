...
namespace NW
{
	class NW_API app_wnd_t : public mem_user_t
	{
	public:
		...
		using nw_event_t = nw_event_window_t;
		using event_tc = const nw_event_t;
	...
	public:
		...
		inline v1f_tc get_size_ratio() const { return NW_CAST_FLOAT(get_size_x()) / NW_CAST_FLOAT(get_size_y()); }
...
#	endif
		...
		v1f_t m_ratio;
		v1f_t m_opacity;
		v1bit_t m_is_enabled = NW_FALSE;
		v1bit_t m_is_hovered = NW_FALSE;
		v1bit_t m_is_focused = NW_FALSE;
