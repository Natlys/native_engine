#ifndef NC_MEM_CORE_H
#   define NC_MEM_CORE_H
// config //
// includes //
...
#   if !(defined NC_MEM_DEFAULT_CELL_SIZE)
#       define NC_MEM_MINIMAL_CELL_SIZE ( 1ul << 3ul ) // 8 bytes to store a pointer or size //
#       define NC_MEM_AVERAGE_CELL_SIZE ( 1ul << 4ul ) // 16 bytes to store a pointer and size //
#       define NC_MEM_MAXIMAL_CELL_SIZE ( 1ul << 5ul ) // 32 bytes to store 2 pointers and 2 sizes //
#       define NC_MEM_DEFAULT_CELL_SIZE NC_MEM_AVERAGE_CELL_SIZE
#   endif   // NC_MEM_DEFAULT_CELL_SIZE //
// // functions // //
...
#       define NC_MEM_FREE(ref, size) ({ /*_____________*/ \
            free(ref); ref = NC_NULL; /*________________*/ \
        })
#   endif   // NC_MEM_FREE //
